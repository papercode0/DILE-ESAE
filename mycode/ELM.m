function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,elm_pred] = ELM(train_data, test_data, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
